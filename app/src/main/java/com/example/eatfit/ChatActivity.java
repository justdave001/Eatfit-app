...
import com.example.eatfit.Messages.MessageAdapter;
import com.example.eatfit.Messages.MessageDialog;
import com.example.eatfit.Messages.MessageObject;
import com.example.eatfit.Tasks.ImageCompressAsyncTask;
import com.example.eatfit.Users.UserAdapter;

import com.example.eatfit.Users.UserObject;
...
public class ChatActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUsername = intent.getStringExtra(ChatMainActivity.USERNAME_KEY);
        mAvatarColour = intent.getStringExtra(ChatMainActivity.AVATAR_COLOUR_KEY);
        ...
        if (mSelectedImages != null) {
            if (!mSelectedImages.isEmpty()) {
                ...
                for (Image image : mSelectedImages) {
                    ...
                    String[] params = { image.toString(), mUsername, mAvatarColour, ImageCompressAsyncTask.TRUE };
    ...
    private void setUpUsersViews(){
        ...
        RecyclerView mUsersRecyclerView = findViewById(R.id.users_list);
    ...
    private void setUpMessagesViews(){
        ...
        RecyclerView mMessagesRecyclerView =  findViewById(R.id.messages_list);
    ...
    private void setUpMessageSendViews() {
        ...
        ImageView mEmojiButton =  findViewById(R.id.text_emoji_button);
        ImageView mImagePickerButton = findViewById(R.id.text_entry_image_button);
        mTextField = findViewById(R.id.text_entry_field);
        mSubmitButton =  findViewById(R.id.message_send_button);
        ...
        mImagePickerButton.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                intent.putExtra(ImagePickerActivity.CAMERA_SERVICE, ImagePickerActivity.ACCESSIBILITY_SERVICE);
                intent.putExtra(com.github.dhaval2404.imagepicker.ImagePickerActivity.CAMERA_SERVICE, false);
    ...
    private void checkAndShowMessageDialog() {
        ...
        int counter = ChatMainActivity.sharedPreferences.getInt(DIALOG_COUNTER_KEY, 1);
        boolean dismissed = ChatMainActivity.sharedPreferences.getBoolean(DIALOG_DISMISSED_KEY, false);
                ...
                .setResultCallback(new ResultCallback<Status>() {
                    ...
                    public void onResult(@NonNull Status status) {
                        if (status.isSuccess()){
                            ...
                            showSnackbar(ChatMainActivity.mainContext.getString(R.string.nearby_publish_message_failed));
                        }
                        ...
                        mSubmitButton.setImageDrawable(ContextCompat.getDrawable(ChatMainActivity.mainContext,R.drawable.ic_send_light));
                    }
                });
    }
